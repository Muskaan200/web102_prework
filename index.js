...
console.log(GAMES_JSON.length); // Replace with actual number
...
// create a function that aSETdds all data from the games array to the page
...
// reuse totalRaised from Challenge 4 (don't redeclare it)

// create a string that explains the number of unfunded games using the ternary operator
const summaryText = `A total of $${totalRaised.toLocaleString('en-US')} has been raised for ${GAMES_JSON.length} games. 
...
secondGameElement.textContent = `Second Top Funded Game: ${secondGame.name}`;
